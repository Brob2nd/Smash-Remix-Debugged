...
scope ResultsScreen {
    ...
    add_to_results_screen(Character.id.SANDBAG,  FGM.announcer.names.SANDBAG,                SMASH,           Character.id.CAPTAIN, 175,     SANDBAG,         20,     0.75,      0x0B)
    ...
    add_to_results_screen(Character.id.PEPPY,    FGM.announcer.names.PEPPY,                  STARFOX,         Character.id.FOX,     170,     PEPPY,           30,     1,         {MIDI.id.OLDFALCO_VICTORY})
    add_to_results_screen(Character.id.SLIPPY,   FGM.announcer.names.SLIPPY,                 STARFOX,         Character.id.FOX,     180,     SLIPPY,          25,     1,         {MIDI.id.OLDFALCO_VICTORY})
