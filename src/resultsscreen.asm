...
scope ResultsScreen {
    ...
    add_to_results_screen(Character.id.PEPPY,    FGM.announcer.names.PEPPY,                  STARFOX,         Character.id.FOX,     170,     PEPPY,           30,     1,         {MIDI.id.OLD_FALCO_VICTORY})
    add_to_results_screen(Character.id.SLIPPY,   FGM.announcer.names.SLIPPY,                 STARFOX,         Character.id.FOX,     180,     SLIPPY,          25,     1,         {MIDI.id.OLD_FALCO_VICTORY})
