...
//      beq         v0, r0, 0x801342F4      // original line 1
    ...
    add_stage(norfair, "Norfair", {MIDI.id.NORFAIR}, {MIDI.id.OLDNORFAIR}, {MIDI.id.VSRIDLEY}, OS.FALSE, HAZARDS_OFF_MOVEMENT_ON, OS.TRUE, OS.TRUE, class.BATTLE, -1, -1, -1, -1, -1, 0x05, 0x05, 0x05, default_blue_shell_rate, default_lightning_rate, default_item_rate, default_item_rate,  METROID, Hazards.type.HAZARDS)
