...
scope MIDI {
    ...
    insert_midi(SPIRAL_MOUNTAIN, OS.TRUE, OS.TRUE, "Spiral Mountain (Ultimate)", banjokazooie, 229)
    insert_midi(N64, OS.TRUE, OS.TRUE, "Water Land", sm64, 67)
    insert_midi(MUTE_CITY, OS.TRUE, OS.TRUE, "Mute City (Brawl)", fzero, 172)
    ...
    insert_midi(UNFOUNDED_REVENGE, OS.TRUE, OS.TRUE, "Unfounded Revenge (Brawl)", mother3, 268)
    ...
    insert_midi(SKERRIES, OS.TRUE, OS.TRUE, "Skerries", blastcorps, 134)
    ...
    insert_midi(FRAPPE_SNOWLAND, OS.TRUE, OS.TRUE, "Frappe Snowland/Sherbet Land", mk64, 100)
