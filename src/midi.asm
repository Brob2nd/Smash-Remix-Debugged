...
scope MIDI {
    ...
    add_game(smas, "Super Mario All-stars")
    add_game(smassmw, "Super Mario All-stars + Super Mario World")
    add_game(sm3das, "Super Mario 3D All-stars")
    add_game(sml, "Super Mario Land")
    add_game(sml2, "Super Mario Land 2: 6 Golden Coins")
    add_game(sm3dl, "Super Mario 3D Land")
    add_game(smw, "Super Mario World")
    add_game(sm3dw, "Super Mario 3D World")
    add_game(sm3dwbf, "Super Mario 3D World + Bowser's Fury")
    add_game(sm64, "Super Mario 64")
    add_game(sm64dl, "Super Mario 64: Decades Later")
    add_game(sm64btcm, "Super Mario 64: Beyond the Cursed Mirror")
    add_game(sm74, "Super Mario 74")
    add_game(sm64ww, "Super Mario 64: Warped Worlds")
    add_game(b3313, "B3313")
    add_game(b3313u, "B3313 Unabandoned")
    add_game(sm64ds, "Super Mario 64 DS")
    add_game(sunshine, "Super Mario Sunshine")
    add_game(galaxy, "Super Mario Galaxy")
    add_game(galaxy2, "Super Mario Galaxy 2")
    add_game(odyssey, "Super Mario Odyssey")
    add_game(nsmb, "New Super Mario Bros.")
    add_game(nsmbw, "New Super Mario Bros. Wii")
    add_game(nsmb2, "New Super Mario Bros. 2")
    add_game(nsmbu, "New Super Mario Bros. U")
    add_game(smr, "Super Mario Run")
    add_game(hotelmario, "Hotel Mario")
    add_game(drm, "Dr. Mario")
    add_game(drm64, "Dr. Mario 64")
    add_game(drl, "Dr. Luigi")
    add_game(smk, "Super Mario Kart")
    add_game(smkr, "Super Mario Kart R")
    add_game(mk64, "Mario Kart 64")
    add_game(mksc, "Mario Kart: Super Circuit")
    add_game(mkdd, "Mario Kart: Double Dash!!")
    add_game(mkagp, "Mario Kart Arcade GP")
    add_game(mkds, "Mario Kart DS")
    add_game(mkagp2, "Mario Kart Arcade GP 2")
    add_game(mkw, "Mario Kart Wii")
    add_game(mk7, "Mario Kart 7")
    add_game(mkagpdx, "Mario Kart Arcade GP Deluxe")
    add_game(mk8, "Mario Kart 8")
    add_game(mk8dx, "Mario Kart 8 Deluxe")
    add_game(mkt, "Mario Kart Tour")
    add_game(marioparty, "Mario Party")
    add_game(marioparty2, "Mario Party 2")
    add_game(marioparty3, "Mario Party 3")
    add_game(marioparty4, "Mario Party 4")
    add_game(marioparty5, "Mario Party 5")
    add_game(marioparty6, "Mario Party 6")
    add_game(mariopartyadvance, "Mario Party Advance")
    add_game(marioparty7, "Mario Party 7")
    add_game(marioparty8, "Mario Party 8")
    add_game(mariopartyds, "Mario Party DS")
    add_game(marioparty9, "Mario Party 9")
    add_game(mariopartyislandtour, "Mario Party: Island Tour")
    add_game(marioparty10, "Mario Party 10")
    add_game(mariopartystarrush, "Mario Party Star Rush")
    add_game(mariopartythetop100, "Mario Party: The Top 100")
    add_game(supermarioparty, "Super Mario Party")
    add_game(mariopartysuperstars, "Mario Party Superstars")
    add_game(mariogolf, "Mario Golf")
    add_game(mariogolftoadstooltour, "Mario Golf: Toadstool Tour")
    add_game(mariogolfworldtour, "Mario Golf: World Tour")
    add_game(mariogolfsuperrush, "Mario Golf: Super Rush")
    add_game(mariotennis, "Mario Tennis")
    add_game(mariopowertennis, "Mario Power Tennis")
    add_game(mariotennisopen, "Mario Tennis Open")
    add_game(mariotennisultrasmash, "Mario Tennis: Ultra Smash")
    add_game(mariotennisaces, "Mario Tennis Aces")
    add_game(smrpg, "Super Mario RPG: Legend of the Seven Stars")
    add_game(papermario, "Paper Mario")
    add_game(papermariothethousandyeardoor, "Paper Mario: The Thousand-Year Door")
    add_game(superpapermario, "Super Paper Mario")
    add_game(papermariostickerstar, "Paper Mario: Sticker Star")
    add_game(papermariocolorsplash, "Paper Mario: Color Splash")
    add_game(papermariotheorigamiking, "Paper Mario: The Origami King")
    add_game(mariopaint, "Mario Paint")
    add_game(talentstudio, "Mario Artist: Talent Studio")
    add_game(paintstudio, "Mario Artist: Paint Studio")
    add_game(polygonstudio, "Mario Artist: Polygon Studio")
    add_game(marioluigi_ss, "Mario and Luigi: Superstar Saga")
    add_game(marioluigi_pit, "Mario and Luigi: Partners in Time")
    add_game(marioluigi_bis, "Mario and Luigi: Bowser's Inside Story")
    add_game(marioluigi_dt, "Mario and Luigi: Dream Team")
    add_game(marioluigi_pj, "Mario and Luigi: Paper Jam")
    ...
    add_game(vbwarioland, "Virtual Boy Wario Land")
    add_game(warioland2, "Wario Land II")
    add_game(warioland3, "Wario Land 3")
    add_game(warioland4, "Wario Land 4")
    add_game(warioshake, "Wario Land - Shake It!")
    add_game(warioworld, "Wario World")
    add_game(wariomasterofdisguise, "Wario: Master of Disguise")
    add_game(warioware, "WarioWare, Inc.: Mega Microgame$!")
    add_game(wwtouched, "WarioWare: Touched!")
    add_game(wwtwisted, "WarioWare: Twisted!")
    add_game(wwsmoothmoves, "WarioWare: Smooth Moves")
    add_game(wwsnapped, "WarioWare: Snapped!")
    add_game(wwdiy, "WarioWare: D.I.Y")
    add_game(gamewario, "Game & Wario")
    add_game(wwgold, "WarioWare: Gold")
    add_game(wwgetittogether, "WarioWare: Get it Together!")
    add_game(wwmoveit, "WarioWare: Move it!")
    add_game(dk, "Donkey Kong")
    add_game(dkjr, "Donkey Kong Jr.")
    add_game(dk3, "Donkey Kong 3")
    add_game(dkl, "Donkey Kong Land")
    add_game(dkl2, "Donkey Kong Land 2")
    add_game(dkl3, "Donkey Kong Land III")
    add_game(dkc, "Donkey Kong Country")
    add_game(dkc2, "Donkey Kong Country 2: Diddy's Kong Quest")
    add_game(dkc3, "Donkey Kong Country 3: Dixie Kong's Double Trouble!")
    add_game(dk64, "Donkey Kong 64")
    add_game(dkr, "Diddy Kong Racing")
    add_game(dkrds, "Diddy Kong Racing DS")
    ...
    add_game(pokemondp, "Pokemon Diamond & Pearl")
    add_game(pokemonbdsp, "Pokemon Brilliant Diamond & Shining Pearl")
    ...
    add_game(kirbysuperstarultra, "Kirby Super Star Ultra")
    ...
    add_game(ultimate, "Super Smash Bros. Ultimate")
    add_game(flash, "Super Smash Flash")
    add_game(flash2, "Super Smash Flash 2")
    add_game(crusade, "Super Smash Bros. Crusade")
    ...
    add_game(banjokazooiegruntyrevenge, "Banjo-Kazooie: Grunty's Revenge")
    add_game(banjopilot, "Banjo-Pilot")
    add_game(banjokazooienutsbolts, "Banjo-Kazooie: Nuts & Bolts")
    ...
    add_game(persona2, "Persona 2")
    add_game(persona3, "Persona 3")
    add_game(persona4, "Persona 4")
    ...
    add_game(sonicgenerations, "Sonic Generations")
    add_game(sonicmania, "Sonic Mania")
    add_game(sonicmaniaplus, "Sonic Mania Plus")
    add_game(sonicorigins, "Sonic Origins")
    add_game(sonicoriginsplus, "Sonic Origins Plus")
    add_game(sonicsuperstars, "Sonic Superstars")
    add_game(sonic4episode1, "Sonic the Hedgehog 4: Episode I")
    add_game(sonic4episode2, "Sonic the Hedgehog 4: Episode II")
    add_game(sonicadventure, "Sonic Adventure")
    add_game(sonicadventure2, "Sonic Adventure 2")
    add_game(sonicadventure2battle, "Sonic Adventure 2: Battle")
    add_game(sonicheroes, "Sonic Heroes")
    add_game(sonicadvance, "Sonic Advance")
    add_game(sonicadvance2, "Sonic Advance 2")
    add_game(sonicadvance3, "Sonic Advance 3")
    add_game(sonicrush, "Sonic Rush")
    add_game(sonicrushadventure, "Sonic Rush Adventure")
    add_game(sonicunleashed, "Sonic Unleashed")
    add_game(sonicforces, "Sonic Forces")
    add_game(sonicforcesspeedbattle, "Sonic Forces: Speed Battle")
    ...
    add_game(splatoon, "Splatoon")
    add_game(splatoon2, "Splatoon 2")
    add_game(splatoon3, "Splatoon 3")
    ...
    add_game(ssf2tx, "Super Street Fighter II: The New Challengers (X68000)")
    OS.align(4)
    ...
    insert_midi(SPIRAL_MOUNTAIN, OS.TRUE, OS.TRUE, "Spiral Mountain (Ultimate)", banjokazooie)
    insert_midi(N64, OS.TRUE, OS.TRUE, "Jolly Roger Bay/Dire, Dire Docks", sm64)
    ...
    insert_midi(KITCHEN_ISLAND, OS.TRUE, OS.TRUE, "Wario Land Theme", warioland)
    ...
    insert_midi(UNFOUNDED_REVENGE, OS.TRUE, OS.TRUE, "Unfounded Revenge (Brawl)", mother3)
    ...
    insert_midi(VENOM, OS.TRUE, OS.TRUE, "Venom Level 1", starfox)
    ...
    insert_midi(BUBBLY, OS.TRUE, OS.TRUE, "Bubbly Clouds", kirbydreamland)
    insert_midi(ROADTOCERULEANCITY, OS.TRUE, OS.TRUE, "Road to Cerulean City", pokemonred)
    insert_midi(LEVEL1_WARIO, OS.TRUE, OS.TRUE, "Stage 1", warioland)
    insert_midi(MABE, OS.TRUE, OS.TRUE, "Mabe Village", awakening)
    insert_midi(REST, OS.TRUE, OS.TRUE, "Rest Area", ssbr)
    ...
    insert_midi(GIANTWING, OS.TRUE, OS.TRUE, "Giant Wing (Fire Stone)", sonicfighters)
    ...
    insert_midi(FILESELECT_SM64, OS.TRUE, OS.TRUE, "File Select", sm64)
    insert_midi(ITSATRAP_SM64, OS.TRUE, OS.TRUE, "File Select (Alternate)", sm64)
    insert_extra_midi(BANJO_VICTORY)
    insert_midi(BLASTCORPS_MENU, OS.TRUE, OS.TRUE, "Menu (Blast Corps)", blastcorps)
    insert_midi(FRAPPE_SNOWLAND, OS.TRUE, OS.TRUE, "Frappe Snowland/Sherbet Land", mk64)
    ...
    insert_midi(CONKER_THE_KING, OS.TRUE, OS.TRUE, "Conker the King (Reprise)", conker)
    ...
    insert_midi(DKROPTIONS, OS.TRUE, OS.TRUE, "Options (Diddy Kong Racing)", dkr)
    insert_midi(GALLERY, OS.TRUE, OS.TRUE, "Gallery", ssbr)
    insert_midi(QUEQUE, OS.TRUE, OS.TRUE, "Que Que", drm64)
    insert_midi(MK64MENU, OS.TRUE, OS.TRUE, "Setup and Kart Select", mk64)
    ...
    insert_midi(SMB2BOSS, OS.TRUE, OS.TRUE, "Super Mario Bros. 2 Boss", smb2)
    ...
    insert_midi(PLAY_A_MINIGAME, OS.TRUE, OS.TRUE, "Play a Mini-Game!", marioparty)
    ...
    insert_midi(TEMPLE_8BIT, OS.TRUE, OS.TRUE, "Temple Theme (8-bit)", zelda2)
    ...
    insert_midi(DK_RAPMELEE, OS.TRUE, OS.TRUE, "DK Rap (Melee)", dk64)
    insert_midi(JUNGLEJAPES64, OS.TRUE, OS.TRUE, "Jungle Japes", dk64)
    insert_midi(OLDSPIRAL_MOUNTAIN, OS.TRUE, OS.TRUE, "Spiral Mountain", banjokazooie)
    insert_midi(OLDUNFOUNDED_REVENGE, OS.TRUE, OS.TRUE, "Unfounded Revenge", mother3)
    insert_midi(ROUTE209, OS.TRUE, OS.TRUE, "Route 209", pokemondp)
    ...
    insert_midi(EFORT, OS.TRUE, OS.TRUE, "Eternal Fort", b3313)
    insert_midi(FLOOR2B, OS.TRUE, OS.TRUE, "Floor 2B", b3313)
    ...
    insert_midi(OLDBEWARE_THE_FORESTS_MUSHROOMS, OS.TRUE, OS.TRUE, "Beware the Forest's Mushrooms (Old ver.)", smrpg)
    insert_midi(OLDBOWSERBOSS, OS.TRUE, OS.TRUE, "Koopa's Theme (Old ver.)", sm64)
    insert_midi(OLDFD_BRAWL, OS.TRUE, OS.TRUE, "Final Destination (Brawl, Old ver.)", brawl)
    insert_midi(OLDNORFAIR, OS.TRUE, OS.TRUE, "Brinstar Depths (Melee, Old ver.)", metroid)
    insert_midi(OLDSLOPRANO, OS.TRUE, OS.TRUE, "Sloprano (Old ver.)", conker)
    ...
    insert_midi(SMASHVILLEOLD, OS.TRUE, OS.TRUE, "Town Hall and Tom Nook's Store (Old ver.)", acww)
    ...
    insert_midi(OLDGREEN_HILL_ZONE, OS.TRUE, OS.TRUE, "Green Hill Zone (Old ver.)", sonic1)
    insert_midi(OLDBRAWL, OS.TRUE, OS.TRUE, "Brawl Menu (Old ver.)", brawl)
    insert_midi(OLDCLOCKTOWER, OS.TRUE, OS.TRUE, "Clock Tower (Old ver.)", mvc2)
    insert_midi(OLDCORRIDORS_OF_TIME, OS.TRUE, OS.TRUE, "Corridors of Time (Old ver.)", chrono)
    insert_midi(OLDHYRULE_TEMPLE, OS.TRUE, OS.TRUE, "Temple Theme (Melee, Old ver.)", zelda2)
    ...
    insert_midi(OLDCORNERIA, OS.TRUE, OS.TRUE, "Corneria (Old ver.)", starfox)
    insert_midi(OLDMUTE_CITY, OS.TRUE, OS.TRUE, "Mute City (Old ver.)", fzero)
    insert_midi(OLDPOKEMON_STADIUM, OS.TRUE, OS.TRUE, "Trainer Battle (Old ver.)", pokemonred)
    insert_midi(OLDDK_RAPMELEE, OS.TRUE, OS.TRUE, "DK Rap (Melee, Old ver.)", dk64)
    insert_midi(OLDGODDESSBALLAD, OS.TRUE, OS.TRUE, "Ballad of the Goddess (Old ver.)", skyward)
    insert_midi(OLDEVEN_DRIER_GUYS, OS.TRUE, OS.TRUE, "Even Drier Guys (Old ver.)", mother3)
    insert_midi(OLDFIRST_DESTINATION, OS.TRUE, OS.TRUE, "Final Destination (Melee, Old ver.)", melee)
    insert_midi(OLDOBSTACLE, OS.TRUE, OS.TRUE, "Obstacle Course (Old ver.)", yoshis_island)
    insert_midi(OLDONETT, OS.TRUE, OS.TRUE, "Onett (Old ver.)", earthbound)
    insert_midi(OLDPOKEMON_CHAMPION, OS.TRUE, OS.TRUE, "Champion Battle (Old ver.)", pokemonred)
    insert_midi(OLDSNAKEY_CHANTEY, OS.TRUE, OS.TRUE, "Snakey Chantey (Old ver.)", dkc2)
    insert_midi(OLDSTARRING_WARIO, OS.TRUE, OS.TRUE, "Starring Wario! (Old ver.)", ddrmm)
    insert_midi(OLDTAZMILY, OS.TRUE, OS.TRUE, "Mom's Hometown (Old ver.)", mother3)
    insert_midi(OLDZEBES_LANDING, OS.TRUE, OS.TRUE, "Upper Brinstar (Old ver.)", supermetroid)
    ...
    insert_midi(BETABOWSER_ROAD, OS.TRUE, OS.TRUE, "Koopa's Road (Beta)", sm64)
    insert_midi(BETADELFINO, OS.TRUE, OS.TRUE, "Delfino Plaza (Beta)", sunshine)
    insert_midi(BETAGREATBAY, OS.TRUE, OS.TRUE, "Saria's Song (Beta)", ocarina)
    insert_midi(BETAPOKEMON_STADIUM, OS.TRUE, OS.TRUE, "Trainer Battle (Beta)", pokemonred)
    ...
    add_instrument(Marimba BK, 0x7E, 0x3F, 0x05, 0x04DD, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0)

    // Shino Mod's 1st custom instrument yaaay
    add_instrument_sample(moogbass, 0x0, 0x0, 66 * 200, 0x7F, 0x7F, 0x0, 0x7F, 0, 127, 60, 0x0, 0x3F, 0x7E, OS.TRUE, 3424 , 3918, 0xFFFFFFFF, OS.FALSE)
    add_instrument(SNES Moog Bass, 0x7E, 0x3F, 0x05, 0x04DD, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0)

    // This thing is a Synth Bass and a Lead at the same time
    add_instrument_sample(Disco_Bass_E2, 0x0, 0x0, 66 * 200, 0x7F, 0x7F, 0x0, 0x7F, 0, 45, 40, 0x0, 0x3F, 0x7E, OS.TRUE, 15719, 17272, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(Disco_Bass_D3, 0x0, 0x0, 66 * 200, 0x7F, 0x7F, 0x0, 0x7F, 46, 59, 51, 0x0, 0x3F, 0x7E, OS.TRUE, 7002, 7825, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(Disco_Bass_C6, 0x0, 0x0, 66 * 200, 0x7F, 0x7F, 0x0, 0x7F, 60, 127, 84, 0x0, 0x3F, 0x7E, OS.TRUE, 10870, 35088, 0xFFFFFFFF, OS.FALSE)
    add_instrument(Hypersonic Disco Bass, 0x7E, 0x3F, 0x05, 0x04DD, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0)

    // Sounds pretty convincing to me...
    add_instrument_sample(Unconvicing_A3, 0x0, 0x0, 66 * 350, 0x7F, 0x7F, 0x0, 0x7F,  0,  75,  69, 0, 0x3F, 0x7E, OS.TRUE, 8849, 94673, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(Unconvicing_F4, 0x0, 0x0, 66 * 350, 0x7F, 0x7F, 0x0, 0x7F, 76,  127,  77, 0, 0x3F, 0x7E, OS.FALSE, 32420, 101267, 0xFFFFFFFF, OS.FALSE)
    add_instrument(U220 Unconvincing Guitar, 0x7E, 0x3F, 0x05, 0x04DD, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0)

    // TODO: Alt (?) Church Organ
    add_instrument_sample(church_organ-0, 0x00000000, 0xFFFFFFFF, 0x00004E20, 0x7F, 0x7F, 0x00, 0x7F, 0x00, 0x7F, 0x4F, 0x00, 0x40, 0x7F, OS.TRUE, 0x000005C7, 0x0000092C, 0xFFFFFFFF, OS.TRUE)
    add_instrument(Church Organ, 0x7F, 0x40, 0x05, 0x04DD, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0)

    // TODO: Better than Mother 3/WarioWare Rock Organ
    add_instrument_sample(rock_organ-0, 0x00000000, 0xFFFFFFFF, 0x00004E20, 0x7F, 0x7F, 0x00, 0x7F, 0x00, 0x7F, 0x48, 0xFFFFFFD3, 0x40, 0x7F, OS.TRUE, 0x00000922, 0x000011BF, 0xFFFFFFFF, OS.TRUE)
    ...
    // (nevermind, it's NOT a) Eerie flute~
    add_instrument_sample(enigma, 0x0, 0x0, 66 * 350, 0x7F, 0x7F, 0x0, 0x7F, 0,  127,  74, 0x0, 0x3F, 0x7E, OS.TRUE, 65575, 79285, 0xFFFFFFFF, OS.FALSE)
    add_instrument(Erhu, 0x7E, 0x3F, 0x05, 0x04DD, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0)
    ...
    // A powerful Brass for powerful themes :)
    add_instrument_sample(Orson_Brass_C4, 0x0, 0x0, 66 * 350, 0x7F, 0x7F, 0x0, 0x7F, 0,  77,  72, 0x0, 0x3F, 0x7E, OS.TRUE, 10769, 78434, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(Orson_Brass_C5, 0x0, 0x0, 66 * 350, 0x7F, 0x7F, 0x0, 0x7F, 78, 127,  84, 0x0, 0x3F, 0x7E, OS.TRUE, 10929, 78667, 0xFFFFFFFF, OS.FALSE)
    add_instrument(Orson Synth Brass, 0x7E, 0x3F, 0x05, 0x04DD, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0)

    // Also known as Romantic Trumpet
    add_instrument_sample(Solo_Trumpet_SRX_C6, 0x0, 0x0, 66 * 350, 0x7F, 0x7F, 0x0, 0x7F, 0,  96,  96, 0x0, 0x3F, 0x7E, OS.TRUE, 18444, 24507, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(Solo_Trumpet_SRX_D6, 0x0, 0x0, 66 * 350, 0x7F, 0x7F, 0x0, 0x7F, 97, 127,  99, 0x0, 0x3F, 0x7E, OS.TRUE, 21537, 27457, 0xFFFFFFFF, OS.FALSE)
    add_instrument(Solo Trumpet, 0x7E, 0x3F, 0x05, 0x04DD, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0)
    ...
    add_instrument(Sitar, 0x7E, 0x3F, 0x05, 0x04DD, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0)

    // What's up, S L A P P E R S
    add_instrument_sample(JS_Bass_G1, 0x0, 0x0, 66 * 500, 0x7F, 0x7F, 0x0, 0x7F, 0,  44,  43, 0x0, 0x3F, 0x7E, OS.TRUE, 9336, 9987, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(JS_Bass_A1, 0x0, 0x0, 66 * 500, 0x7F, 0x7F, 0x0, 0x7F, 45, 47, 46, 0x0, 0x3F, 0x7E, OS.TRUE, 8931, 9474, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(JS_Bass_C2, 0x0, 0x0, 66 * 500, 0x7F, 0x7F, 0x0, 0x7F, 48,  49,  48, 0x0, 0x3F, 0x7E, OS.TRUE, 7923, 8412, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(JS_Bass_D2, 0x0, 0x0, 66 * 500, 0x7F, 0x7F, 0x0, 0x7F, 50, 52, 50, 0x0, 0x3F, 0x7E, OS.TRUE, 10309, 10741, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(JS_Bass_G3, 0x0, 0x0, 66 * 500, 0x7F, 0x7F, 0x0, 0x7F, 53,  55,  55, 0x0, 0x3F, 0x7E, OS.TRUE, 11658, 11984, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(JS_Bass_C4, 0x0, 0x0, 66 * 500, 0x7F, 0x7F, 0x0, 0x7F, 56, 60, 60, 0x0, 0x3F, 0x7E, OS.TRUE, 15996, 16240, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(JS_Bass_E4, 0x0, 0x0, 66 * 500, 0x7F, 0x7F, 0x0, 0x7F, 61,  73,  64, 0x0, 0x3F, 0x7E, OS.TRUE, 5303, 5496, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(JS_Pop_G1, 0x0, 0x0, 66 * 500, 0x7F, 0x7F, 0x0, 0x7F, 74, 82, 79, 0x0, 0x3F, 0x7E, OS.TRUE, 6405, 7053, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(JS_Pop_C2, 0x0, 0x0, 66 * 500, 0x7F, 0x7F, 0x0, 0x7F, 83,  92,  84, 0x0, 0x3F, 0x7E, OS.TRUE, 5591, 6553, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(JS_Pop_C3, 0x0, 0x0, 66 * 500, 0x7F, 0x7F, 0x0, 0x7F, 93, 97, 96, 0x0, 0x3F, 0x7E, OS.TRUE, 6189, 6675, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(JS_Pop_F3, 0x0, 0x0, 66 * 500, 0x7F, 0x7F, 0x0, 0x7F, 98,  102,  101, 0x0, 0x3F, 0x7E, OS.TRUE, 7240, 7604, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(JS_Pop_G3, 0x0, 0x0, 66 * 500, 0x7F, 0x7F, 0x0, 0x7F, 103, 109, 103, 0x0, 0x3F, 0x7E, OS.TRUE, 5550, 5873, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(JS_Pop_F4, 0x0, 0x0, 66 * 500, 0x7F, 0x7F, 0x0, 0x7F, 110,  116,  113, 0x0, 0x3F, 0x7E, OS.TRUE, 5337, 5520, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(JS_Pop_A4, 0x0, 0x0, 66 * 500, 0x7F, 0x7F, 0x0, 0x7F, 117, 127, 118, 0x0, 0x3F, 0x7E, OS.TRUE, 3144, 3280, 0xFFFFFFFF, OS.FALSE)
    add_instrument(Fat Slap/Pop bASS, 0x7E, 0x3F, 0x05, 0x04DD, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0)
	
    // Rock the drums!
    add_instrument_sample(83_ALL_HH_OPEN_1_2, 0x0, 0x004C4B40, 66 * 450, 0x7F, 0x0, 0x0, 0x7F, 34, 34,  28, 0x0, 0x3F, 0x7E, OS.FALSE, 0, 0, 0, OS.FALSE)
    add_instrument_sample(kik_pds_b-0c_2, 0x0, 0x004C4B40, 66 * 350, 0x7F, 0x0, 0x0, 0x7F, 35, 35, 35, 0x0, 0x3F, 0x7E, OS.FALSE, 0, 0, 0, OS.FALSE)
    add_instrument_sample(ea7638_r8_bd_2, 0x0, 0x004C4B40, 66 * 350, 0x7F, 0x0, 0x0, 0x7F, 36, 36, 36, 0x0, 0x3F, 0x7E, OS.FALSE, 0, 0, 0, OS.FALSE)
    add_instrument_sample(SNR_ROCK, 0x0, 0x004C4B40, 66 * 500, 0x7F, 0x0, 0x0, 0x7F, 37, 37,  37, 0x0, 0x3F, 0x7E, OS.FALSE, 0, 0, 0, OS.FALSE)
    add_instrument_sample(ea8704_sd_house_2, 0x0, 0x004C4B40, 66 * 350, 0x7F, 0x0, 0x0, 0x7F, 38, 38, 38, 0x0, 0x3F, 0x7E, OS.FALSE, 0, 0, 0, OS.FALSE)
    add_instrument_sample(Roland_D20_Snare, 0x0, 0x004C4B40, 66 * 350, 0x7F, 0x0, 0x0, 0x7F, 40, 40, 40, 0x0, 0x3F, 0x7E, OS.FALSE, 0, 0, 0, OS.FALSE)
    add_instrument_sample(YAM_TOM_9_low, 0x0, 0x004C4B40, 66 * 350, 0x7F, 0x0, 0x0, 0x7F, 41, 41, 41, 0x0, 0x3F, 0x7E, OS.FALSE, 0, 0, 0, OS.FALSE)
    add_instrument_sample(ea7835_r8_hh_2, 0x0, 0x004C4B40, 66 * 250, 0x7F, 0x0, 0x0, 0x7F, 42, 42, 42, 0x0, 0x3F, 0x7E, OS.FALSE, 0, 0, 0, OS.FALSE)
    add_instrument_sample(YAM_TOM_9_mid, 0x0, 0x004C4B40, 66 * 350, 0x7F, 0x0, 0x0, 0x7F, 43, 43, 43, 0x0, 0x3F, 0x7E, OS.FALSE, 0, 0, 0, OS.FALSE)
    add_instrument_sample(YAM_TOM_9_himid, 0x0, 0x004C4B40, 66 * 350, 0x7F, 0x0, 0x0, 0x7F, 45, 45, 45, 0x0, 0x3F, 0x7E, OS.FALSE, 0, 0, 0, OS.FALSE)
    add_instrument_sample(ea7836_r8_oh_2, 0x0, 0x005B8D80, 66 * 500, 0x7F, 0x0, 0x0, 0x7F, 46, 46, 46, 0x0, 0x3F, 0x7E, OS.TRUE, 12625, 21742, 0x05, OS.FALSE)
    add_instrument_sample(YAM_TOM_9_hi, 0x0, 0x004C4B40, 66 * 350, 0x7F, 0x0, 0x0, 0x7F, 47, 47,  47, 0x0, 0x3F, 0x7E, OS.FALSE, 0, 0, 0, OS.FALSE)
    add_instrument_sample(EA7932_R8_Gong_8, 0x0, 0x00250000, 66 * 5000, 0x7F, 0x0, 0x0, 0x7F, 48, 48,  55, 0x0, 0x3F, 0x7E, OS.TRUE, 11880, 21508, 0x04, OS.FALSE)
    add_instrument_sample(01w_crash_2, 0x0, 0x00180000, 66 * 1000, 0x7F, 0x0, 0x0, 0x7F, 49, 61,  55, 0x0, 0x3F, 0x7E, OS.TRUE, 11880, 21508, 0x04, OS.FALSE)
    add_instrument_sample(BODHRAN_3A_3, 0x0, 0x004C4B40, 66 * 350, 0x7F, 0x0, 0x0, 0x7F, 62, 70,  66, 0x0, 0x3F, 0x7E, OS.FALSE, 0, 0, 0, OS.FALSE)
    add_instrument_sample(SHEKO_1A_2, 0x0, 0x004C4B40, 66 * 350, 0x7F, 0x0, 0x0, 0x7F, 71, 72,  72, 0x0, 0x3F, 0x7E, OS.FALSE, 0, 0, 0, OS.FALSE)
    add_instrument_sample(EA7908_R8_Perc_2, 0x0, 0x004C4B40, 66 * 350, 0x7F, 0x0, 0x0, 0x7F, 74, 74,  74, 0x0, 0x3F, 0x7E, OS.FALSE, 0, 0, 0, OS.FALSE)
    add_instrument_sample(EA7909_R8_Perc_2, 0x0, 0x004C4B40, 66 * 350, 0x7F, 0x0, 0x0, 0x7F, 76, 76,  76, 0x0, 0x3F, 0x7E, OS.FALSE, 0, 0, 0, OS.FALSE)
    add_instrument_sample(EA7940_R8_Perc_2, 0x0, 0x004C4B40, 66 * 350, 0x7F, 0x0, 0x0, 0x7F, 77, 77,  77, 0x0, 0x3F, 0x7E, OS.FALSE, 0, 0, 0, OS.FALSE)
    add_instrument_sample(BODHRAN_3A_5, 0x0, 0x004C4B40, 66 * 350, 0x7F, 0x0, 0x0, 0x7F, 78, 78,  78, 0x0, 0x3F, 0x7E, OS.FALSE, 0, 0, 0, OS.FALSE)
    add_instrument(Xtra Drumkit, 0x7E, 0x3F, 0x05, 0x04DD, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0)

    // Alto saxo papá
    add_instrument_sample(D50_A.Sax_FF_F4, 0x0, 0x002DC6C0, 66 * 350, 0x7F, 0x7F, 0x0, 0x7F, 0,  65,  65, 0x0, 0x3F, 0x7E, OS.TRUE, 18657, 19754, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(D50_A.Sax_FF_B4, 0x0, 0x002DC6C0, 66 * 350, 0x7F, 0x7F, 0x0, 0x7F, 66, 71,  71, 0x0, 0x3F, 0x7E, OS.TRUE, 10559, 11331, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(D50_A.Sax_FF_D5, 0x0, 0x002DC6C0, 66 * 350, 0x7F, 0x7F, 0x0, 0x7F, 72,  75,  75, 0x0, 0x3F, 0x7E, OS.TRUE, 14114, 14522, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(D50_A.Sax_FF_G5, 0x0, 0x002DC6C0, 66 * 350, 0x7F, 0x7F, 0x0, 0x7F, 76, 79,  79, 0x0, 0x3F, 0x7E, OS.TRUE, 18116, 18768, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(D50_A.Sax_FF_B5, 0x0, 0x002DC6C0, 66 * 350, 0x7F, 0x7F, 0x0, 0x7F, 80,  83,  83, 0x0, 0x3F, 0x7E, OS.TRUE, 11833, 12155, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(D50_A.Sax_FF_D6, 0x0, 0x002DC6C0, 66 * 350, 0x7F, 0x7F, 0x0, 0x7F, 84, 86,  86, 0x0, 0x3F, 0x7E, OS.TRUE, 6809, 7079, 0xFFFFFFFF, OS.FALSE)
    add_instrument_sample(D50_A.Sax_FF_F6, 0x0, 0x002DC6C0, 66 * 350, 0x7F, 0x7F, 0x0, 0x7F, 87, 127,  89, 0x0, 0x3F, 0x7E, OS.TRUE, 10798, 10980, 0xFFFFFFFF, OS.FALSE)
    add_instrument(Alto Saxophone, 0x70, 0x3F, 0x05, 0x04DD, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0)
