...
scope MIDI {
    ...
    insert_midi(OLDDATADYNE, OS.TRUE, OS.TRUE, "dataDyne Central: Defection (Old ver.)", pd)
    ...
    insert_midi(OLDERSLOPRANO, OS.TRUE, OS.TRUE, "Sloprano (Older ver.)", conker)
    ...
    insert_midi(OLDERGERUDO_VALLEY, OS.TRUE, OS.TRUE, "Gerudo Valley (Older ver.)", ocarina)
