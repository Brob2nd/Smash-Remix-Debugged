...
scope MIDI {
    ...
    insert_midi(RBY_GYMLEADER, OS.TRUE, OS.TRUE, "Gym Leader Battle", pokemonred, 161)
    ...
    insert_midi(HILLTOPCHASE, OS.TRUE, OS.TRUE, "Hilltop Chase", kirbysuperstar, 163)
    insert_midi(STATUS, OS.TRUE, OS.TRUE, "Status", mariotennis, 297)
    insert_midi(FF4BOSS, OS.TRUE, OS.TRUE, "Boss Encounter", ff4, 44)
    insert_midi(GRIMREAPERSCAVERN, OS.TRUE, OS.TRUE, "Grim Reaper's Cavern", jackbros, 160)
    ...
    insert_midi(HORROR_LAND, OS.TRUE, OS.TRUE, "Horror Land", marioparty2, 165)
    ...
    insert_midi(BIG_BOO, OS.TRUE, OS.TRUE, "Haunted House", sm64, 162)
    ...
    insert_midi(HOGWILD, OS.TRUE, OS.TRUE, "Hog Wild", crash, 164)
    ...
    insert_midi(HORROR_MANOR, OS.TRUE, OS.TRUE, "Horror Manor", warioworld, 166)
    ...
    insert_midi(GRIMGREENFOREST, OS.TRUE, OS.TRUE, "Grim Green Forest", b3313, 159)
