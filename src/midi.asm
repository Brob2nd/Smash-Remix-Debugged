...
scope MIDI {
    ...
    insert_midi(SKERRIES, OS.TRUE, OS.TRUE, "K. Rool's Acid Punk (Remix)", dkl)
    insert_midi(BEWARE_THE_FORESTS_MUSHROOMS, OS.TRUE, OS.TRUE, "Beware the Forest's Mushrooms (Remix)", smrpg)
    ...
    insert_midi(OLDBEWARE_THE_FORESTS_MUSHROOMS, OS.TRUE, OS.TRUE, "Beware the Forest's Mushrooms", smrpg)
