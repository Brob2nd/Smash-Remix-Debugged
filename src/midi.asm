...
scope MIDI {
    ...
    insert_midi(AQUARIUMLIMBO, OS.TRUE, OS.TRUE, "Aquarium Limbo/Eel Graveyard", b3313)
    insert_midi(ALTAQUARIUMLIMBO, OS.TRUE, OS.TRUE, "Aquarium Limbo/Eel Graveyard (Alternate)", b3313)
    ...
    insert_midi(BOWSERLIBRARY, OS.TRUE, OS.TRUE, "Koopa's Library", sm64ww)
