...
scope MIDI {
    ...
    insert_midi(DK_RAP_MELEE, OS.TRUE, OS.TRUE, "DK Rap (Melee)", dk64, 90)
    ...
    insert_midi(E_FORT, OS.TRUE, OS.TRUE, "Eternal Fortress", b3313, 107)
    insert_midi(FILESELECT_B3313, OS.TRUE, OS.TRUE, "File Select (B3313)", b3313, 116)
    insert_midi(4THFLOOR, OS.TRUE, OS.TRUE, "Fourth Floor (Beta)", b3313, 131)
