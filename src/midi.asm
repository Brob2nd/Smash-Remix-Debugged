...
scope MIDI {
    ...
    insert_midi(SNES_RAINBOW, OS.TRUE, OS.TRUE, "Rainbow Road", smk)
    ...
    insert_midi(BLASTCORPS_MENU, OS.TRUE, OS.TRUE, "Menu", blastcorps)
    ...
    insert_midi(DKROPTIONS, OS.TRUE, OS.TRUE, "Main Menu", dkr)
    insert_midi(GALLERY, OS.TRUE, OS.TRUE, "Gallery", ssbr)
    insert_midi(QUEQUE, OS.TRUE, OS.TRUE, "Que Que", drm64)
    insert_midi(MK64MENU, OS.TRUE, OS.TRUE, "Select Screen", mk64)
