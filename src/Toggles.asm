...
scope Toggles {
    ...
    entry_variant_random:;              entry_bool("Random Select With Variants", OS.TRUE, OS.FALSE, OS.TRUE, OS.TRUE, entry_disable_hud)
    ...
    entry_puff_sing_anim:;              entry_bool("Jigglypuff Sing GFX Anims", OS.TRUE, OS.FALSE, OS.FALSE, OS.TRUE,, entry_l_random_char)
    ...
    entry_yi_clouds:;                           entry_bool("Yoshi's Island Cloud Anims", OS.TRUE, OS.FALSE, OS.FALSE, OS.TRUE, entry_load_profile_stage)
    ...
    entry_random_stage_dream_land_beta_1:;      entry_bool("Dream Land Beta 1", OS.TRUE, OS.FALSE, OS.FALSE, OS.FALSE, entry_random_stage_dream_land_beta_2)
    entry_random_stage_dream_land_beta_2:;      entry_bool("Dream Land Beta 2", OS.TRUE, OS.FALSE, OS.FALSE, OS.FALSE, entry_random_stage_duel_zone)
    ...
    entry_random_stage_how_to_play:;            entry_bool("How to Play", OS.TRUE, OS.FALSE, OS.FALSE, OS.FALSE, entry_random_stage_hyrule_castle)
