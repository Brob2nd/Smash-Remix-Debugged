...
scope Toggles {
    ...
    entry_puff_sing_anim:;              entry_bool("Jigglypuff Sing GFX Anims", OS.FALSE, OS.FALSE, OS.FALSE, OS.FALSE, entry_mewtwo_custom_usmash_gfx)
    entry_mewtwo_custom_usmash_gfx:;     entry_bool("Mewtwo Custom Up Smash GFX", OS.FALSE, OS.FALSE, OS.FALSE, OS.FALSE, entry_l_random_char)
